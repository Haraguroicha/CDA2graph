...
## 第二節 研究動機
在國際上，雲端服務與雲端醫療的爭相競爭之下，病歷資料的交換互通與即時處理顯示已經成為了未來的趨勢。尤其是國內的電子病歷交換之後，面臨到的是系統是否能夠即時顯示，以及沒有部屬EEC Gateway的醫院是否能夠參與電子病歷資料交換或者調閱的能力。在目前的政策與法規之下，若沒有EEC Gateway則無法參與電子病歷的交換。

在醫療雲的競爭，以及國際上電子病歷的盛行之下，電子病歷的交換與通行是不可或缺，但是因為建置的成本門檻不低，導致各級醫療院所興致缺缺，推行進度緩慢。
...
## 第三節 研究目的
為了可以增加政府推行電子病歷的成效，以及減少建制ECC Gateway時所付出的成本，並且以現有技術考量，建立一套得以使各家醫療院所產出的電子病歷互通檢視的雲端平台，以及能夠透過各家醫療院所客製化的表單至其他單位供檢視使用。若有電子照護，則也可協助病患自行使用此平台，迅速檢視自己的照護資料。
...
## 第四節 研究流程與步驟
依據研究動機來決定並確認其研究目的之範圍，並進行國內、外的文獻、規範、書籍做探討，並且彙整後先瞭解技術的可行性，以及能否符合預期設計和目標，最後實作系統，並且實際檢查是否能夠達到預期目標。下圖所示本研究的研究流程與步驟：
