...
而目前一〇一年衛生署即將推行打造「全民健康雲」，該計劃率先使用微軟的Windows Azure平台，整合健康、醫療、保險等相關機構所持有的個人健康履歷，包括施打疫苗、健康檢查、就醫診療、門診用藥紀錄、醫療保險等資訊。現階段產生符合標準CDA文件對於醫療單位已是必備條件，為了符合日後的政策及趨勢，資料交換已經不是主要的重點，而是這些資料交換後要如何有效地被利用與如何有效的讓這些資料的擁有者更有效的使用，這些重點就是在於如何呈現這些資料的結果，電子病歷的呈現方式在目前仍有極大的發展空間！
