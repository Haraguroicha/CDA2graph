...
function sample() {
	...
	setTimeout('cda2g.Pages.appendHTML("<span id=\'testFont1\'></span>");', 100);
	setTimeout('cda2g.Pages.appendHTML("<span id=\'testFont2\'></span>");', 150);
	setTimeout('cda2g.Pages.appendHTML("test測試123 ".repeat(50));', 300);
	setTimeout('cda2g.Pages.appendHTML("test測試123 ".repeat(500));', 450);
	...
	setTimeout('cda2g.Pages.appendHTML("test測試123 ".repeat(1500));', 600);
	setTimeout(function () {
		var templateANSI = "";
