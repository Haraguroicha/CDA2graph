...
function sample() {
	setTimeout('cda2g.Pages.appendHTML("<span id=\'testFont\'></span>");', 50);
	setTimeout('cda2g.Pages.appendHTML("<span id=\'testFont1\'></span>");', 150);
	setTimeout('cda2g.Pages.appendHTML("<span id=\'testFont2\'></span>");', 250);
	setTimeout('cda2g.Pages.appendHTML("test測試123 ".repeat(50));', 500);
	setTimeout('cda2g.Pages.appendHTML("test測試123 ".repeat(500));', 1000);
	...
	setTimeout('cda2g.Pages.appendHTML("test測試123 ".repeat(1500));', 2000);
	setTimeout(function () {
		var templateANSI = "";
